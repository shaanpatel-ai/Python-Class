...
def remove_existing(pb):
    query = str(input("Please entar the name of the contact you wish to remove: "))
    temp = 0
...
def search_existing(pb):
    choice = int(input("Enter search critairia\n\n\n 1. Name\n2. Number \n3.Email-id\n4. DOB\n5. Category:"))
    temp = []
    check = -1
    if choice == 1:
        ...
        for i in range(len(pb)):
            ...
            query = int(input("Please enter the number of contact: "))
            for i in range(len(pb)):
                if query == pb[i][1]:
                    check = i
                    temp.append(pb[i])
            ...
            for i in range(len(pb)):
                ...
                query = str(input("Please enter the catogory of the contact you wish to search: "))
                for i in range(len(pb)):
                    if query == pb[i][4]:
                        check = i
                        temp.append(pb[i])
    else:
        print("Invalid search critaria")
        return -1
    if check == -1:
        return -1
    else:
...
print("Hello welcome to this phonebook")
print("You may prosseed to explore this directory")
print("**********************************************************************************************************")
ch = 1
pb = inital_phonebook()
while ch in (1,2,3,4,5):
    ...
    if ch == 1:
        ...
        if d == -1:
            print("The contact does not exit. Please try again")
    elif ch == 5:
        pb = display_all(pb)
    else:
        thanks()